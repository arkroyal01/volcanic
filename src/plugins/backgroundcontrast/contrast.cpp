...
#if HAVE_VULKAN
// clang-format off
// Source GLSL for both shaders below lives in this comment so the SPIR-V can
// be regenerated:
//
//   // contrast_bg.vert — Y-flipped UV to match negative-height viewport
//   // (NDC Y-up) against Y-down capture image layout.
//   #version 450
...
//   }
//
//   // contrast_bg.frag — outputs premultiplied alpha for blending with dst.
//   // At opacity=0 the alpha is 0, so dst is preserved regardless of what the
//   // capture contains (avoids ghost remnants when partial repaint happens
//   // to leave stale pixels at our blit source).
//   #version 450
//   layout(location = 0) in vec2 fragTexCoord;
//   layout(location = 0) out vec4 outColor;
//   layout(set = 0, binding = 0) uniform sampler2D src;
//   layout(push_constant) uniform PC { mat4 colorMatrix; float opacity; } pc;
//   void main() {
//       vec4 color = texture(src, fragTexCoord);
//       vec3 transformed = (color * pc.colorMatrix).rgb;
//       outColor = vec4(transformed * pc.opacity, pc.opacity);
//   }
//
// Build: `glslc -O contrast_bg.{vert,frag} -o contrast_bg.{vert,frag}.spv`

// Full-screen triangle vertex shader: outputs Y-flipped UV [0,1]x[0,1] from
// gl_VertexIndex (see GLSL above for the why).
static const uint32_t s_contrastBgVertSpv[] = {
    ...
    0x00000004, 0x6e69616d, 0x00000000, 0x0000000c, 0x00000018, 0x00000028,
    0x00040047, 0x0000000c, 0x0000000b, 0x0000002a, 0x00040047, 0x00000018,
    0x0000001e, 0x00000000, 0x00030047, 0x00000026, 0x00000002, 0x00050048,
    0x00000026, 0x00000000, 0x0000000b, 0x00000000, 0x00050048, 0x00000026,
    0x00000001, 0x0000000b, 0x00000001, 0x00050048, 0x00000026, 0x00000002,
    0x0000000b, 0x00000003, 0x00050048, 0x00000026, 0x00000003, 0x0000000b,
    ...
    0x00000007, 0x0004003b, 0x00000017, 0x00000018, 0x00000003, 0x00040015,
    0x00000019, 0x00000020, 0x00000000, 0x0004002b, 0x00000006, 0x0000001e,
    0x3f800000, 0x0004002b, 0x00000019, 0x0000001f, 0x00000001, 0x00040017,
    0x00000024, 0x00000006, 0x00000004, 0x0004001c, 0x00000025, 0x00000006,
    0x0000001f, 0x0006001e, 0x00000026, 0x00000024, 0x00000006, 0x00000025,
    0x00000025, 0x00040020, 0x00000027, 0x00000003, 0x00000026, 0x0004003b,
    0x00000027, 0x00000028, 0x00000003, 0x0004002b, 0x0000000a, 0x00000029,
    0x00000000, 0x0004002b, 0x00000006, 0x0000002b, 0x40000000, 0x0004002b,
    0x00000006, 0x0000002f, 0x00000000, 0x00040020, 0x00000033, 0x00000003,
    0x00000024, 0x0005002c, 0x00000007, 0x00000037, 0x0000001e, 0x0000001e,
    ...
    0x00000016, 0x00000012, 0x00000015, 0x00050083, 0x00000006, 0x00000022,
    0x0000001e, 0x00000015, 0x00050050, 0x00000007, 0x00000023, 0x00000012,
    0x00000022, 0x0003003e, 0x00000018, 0x00000023, 0x0005008e, 0x00000007,
    0x0000002c, 0x00000016, 0x0000002b, 0x00050083, 0x00000007, 0x0000002e,
    0x0000002c, 0x00000037, 0x00050051, 0x00000006, 0x00000030, 0x0000002e,
    0x00000000, 0x00050051, 0x00000006, 0x00000031, 0x0000002e, 0x00000001,
    0x00070050, 0x00000024, 0x00000032, 0x00000030, 0x00000031, 0x0000002f,
    0x0000001e, 0x00050041, 0x00000033, 0x00000034, 0x00000028, 0x00000029,
    0x0003003e, 0x00000034, 0x00000032, 0x000100fd, 0x00010038,
};
// Fragment shader: sample capture, apply 4x4 color matrix, output premultiplied
// (rgb*opacity, opacity) so the pipeline can blend with the destination.
static const uint32_t s_contrastBgFragSpv[] = {
    0x07230203, 0x00010000, 0x000d000b, 0x00000031, 0x00000000, 0x00020011,
    0x00000001, 0x0006000b, 0x00000001, 0x4c534c47, 0x6474732e, 0x3035342e,
    0x00000000, 0x0003000e, 0x00000000, 0x00000001, 0x0007000f, 0x00000004,
    0x00000004, 0x6e69616d, 0x00000000, 0x00000011, 0x00000024, 0x00030010,
    ...
    0x0000001e, 0x00000000, 0x00030047, 0x00000019, 0x00000002, 0x00040048,
    0x00000019, 0x00000000, 0x00000005, 0x00050048, 0x00000019, 0x00000000,
    0x00000007, 0x00000010, 0x00050048, 0x00000019, 0x00000000, 0x00000023,
    0x00000000, 0x00050048, 0x00000019, 0x00000001, 0x00000023, 0x00000040,
    0x00040047, 0x00000024, 0x0000001e, 0x00000000, 0x00020013, 0x00000002,
    0x00030021, 0x00000003, 0x00000002, 0x00030016, 0x00000006, 0x00000020,
    0x00040017, 0x00000007, 0x00000006, 0x00000004, 0x00090019, 0x0000000a,
    ...
    0x00040017, 0x00000014, 0x00000006, 0x00000003, 0x00040018, 0x00000018,
    0x00000007, 0x00000004, 0x0004001e, 0x00000019, 0x00000018, 0x00000006,
    0x00040020, 0x0000001a, 0x00000009, 0x00000019, 0x0004003b, 0x0000001a,
    0x0000001b, 0x00000009, 0x00040015, 0x0000001c, 0x00000020, 0x00000001,
    0x0004002b, 0x0000001c, 0x0000001d, 0x00000000, 0x00040020, 0x0000001e,
    0x00000009, 0x00000018, 0x00040020, 0x00000023, 0x00000003, 0x00000007,
    0x0004003b, 0x00000023, 0x00000024, 0x00000003, 0x0004002b, 0x0000001c,
    0x00000026, 0x00000001, 0x00040020, 0x00000027, 0x00000009, 0x00000006,
    0x00050036, 0x00000002, 0x00000004, 0x00000000, 0x00000003, 0x000200f8,
    ...
    0x0000000e, 0x00000012, 0x00050041, 0x0000001e, 0x0000001f, 0x0000001b,
    0x0000001d, 0x0004003d, 0x00000018, 0x00000020, 0x0000001f, 0x00050090,
    0x00000007, 0x00000021, 0x00000013, 0x00000020, 0x0008004f, 0x00000014,
    0x00000022, 0x00000021, 0x00000021, 0x00000000, 0x00000001, 0x00000002,
    0x00050041, 0x00000027, 0x00000028, 0x0000001b, 0x00000026, 0x0004003d,
    0x00000006, 0x00000029, 0x00000028, 0x0005008e, 0x00000014, 0x0000002a,
    0x00000022, 0x00000029, 0x00050051, 0x00000006, 0x0000002d, 0x0000002a,
    0x00000000, 0x00050051, 0x00000006, 0x0000002e, 0x0000002a, 0x00000001,
    0x00050051, 0x00000006, 0x0000002f, 0x0000002a, 0x00000002, 0x00070050,
    0x00000007, 0x00000030, 0x0000002d, 0x0000002e, 0x0000002f, 0x00000029,
    0x0003003e, 0x00000024, 0x00000030, 0x000100fd, 0x00010038,
};
// clang-format on
#endif // HAVE_VULKAN
...
bool ContrastEffect::initVulkanResources()
{
    ...
    // Premultiplied alpha blend: src = (rgb*opacity, opacity), output mixes with
    // destination as final = src + dst*(1 - src.a). At opacity=0 the destination
    // is untouched regardless of what the capture contains — this is what
    // prevents the ghost when partial repaint leaves stale pixels at our blit
    // source during a close animation.
